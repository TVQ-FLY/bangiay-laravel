                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-footer">
                                        ...
                                        <div class="pull-right">
                                            <a href="http://127.0.0.1:8000/admin-auth/login" class="btn btn-default btn-flat">Đăng xuất</a>
                                        </div>
                                    </li>
                                </ul>
                            </li>
...
{{--                            </li>--}}
            ...
            <footer class="main-footer">
                ...
                <strong>Copyright &copy; 2024 <a href="https://adminlte.io">Lê Thị Minh</a>.</strong> All rights
                reserved.
            </footer>
            <!-- Control Sidebar -->
