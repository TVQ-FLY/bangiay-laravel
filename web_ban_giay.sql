...
-- Thời gian đã tạo: Th1 20, 2023 lúc 01:54 PM
...
(1, 'Nguyễn Thành Trung', 'admin@gmail.com', '$2y$10$wkjMG/vGGEJ21wIARDJDiOZnBxO8p5eyDrc3gw.0E9.oKNKqp0QD.', '0343754517', NULL, NULL, NULL, NULL, NULL, NULL);
...
(9, 6, 11, 0, 1, 1550000, '42', 'Màu xanh', 1, NULL, NULL),
(10, 6, 4, 10, 1, 225000, '42', NULL, 1, NULL, NULL),
(11, 7, 4, 10, 2, 225000, '42', NULL, 1, NULL, NULL);
...
(4, 'Giày Thể Thao Nam BAZAS BZ629', 'giay-the-thao-nam-bazas-bz629', 250000, 0, 2, 0, 10, '2020-06-19__b15c67f6ffd80d4941a5bc45b3435d03.jpg', 3, 1, 1, 5, NULL, '<p>Giới Thiệu Sản Phẩm</p>\r\n\r\n<p>M&atilde; sản phẩm:BZ629</p>\r\n\r\n<p>M&agrave;u sắc: Đen Trắng , Đen Đỏ</p>\r\n\r\n<p>T&iacute;nh năng: Chịu m&agrave;i m&ograve;n cao, nhẹ, hấp thụ sốc, tho&aacute;ng kh&iacute;</p>\r\n\r\n<p>Chất liệu đế: Cao su</p>\r\n\r\n<p>Chất liệu b&ecirc;n trong: Vải Chống M&ugrave;i</p>\r\n\r\n<p>Phong c&aacute;ch : Thể Thao , Casual , gi&agrave;y chạy bộ</p>', 0, 0, 0, '2020-06-19 07:52:58', 50, 6, '2023-01-20 06:40:14'),
...
(1, 'slide 11', '/', '2020-06-18__banner-vietmax-0406-9675c8d4e6e340379434f671512c09d7-master.jpg', 1, 1, 1, '2023-01-19 07:20:49', '2023-01-19 07:20:49'),
...
CREATE TABLE IF NOT EXISTS `transactions` (
  ...
  `tst_code` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
(6, 7, 1775000, 'Nguyễn Thanh Lâm', 'thanhlam@gmail.com', '0123456789', '55A Điện Biên Phủ TP Hồ Chí Minh', 'OK', 3, 1, '3q06w3um0vjXxrn', '2023-01-19 08:12:08', '2023-01-20 06:45:39'),
(7, 8, 450000, 'Nguyễn Thành Trung', 'nthanhtrung@gmail.com', '0999999992', '55A Điện Biên Phủ TP Hồ Chí Minh', 'Đóng Gói cẩn thận nha', 3, 1, 'GYWuUh7wXyXtZI7', '2023-01-20 06:40:14', '2023-01-20 06:45:31');
...
(7, 'Nguyễn Thanh Lâm', 'thanhlam@gmail.com', NULL, '$2y$10$XRZYRV0O0uiRhwMlslqmU.Hv.dRZ3MUeQnp2BlRSG7P9A7a920Qtm', '0123456789', '[{\"device\":\"WebKit\",\"platform\":\"Windows\",\"platform_ver\":\"10.0\",\"browser\":\"Chrome\",\"browser_ver\":\"109.0.0.0\",\"time\":\"2023-01-19T15:10:19.466033Z\"}]', 1, NULL, NULL, NULL, '2023-01-19 08:10:07', NULL),
(8, 'Nguyễn Thành Trung', 'nthanhtrung@gmail.com', NULL, '$2y$10$t7oaTNU9CAcaaIUWwYSMSuKipLr.kdmJwaQljSmA4D6UABMgVuaGu', '0999999992', '[{\"device\":\"WebKit\",\"platform\":\"Windows\",\"platform_ver\":\"10.0\",\"browser\":\"Chrome\",\"browser_ver\":\"109.0.0.0\",\"time\":\"2023-01-20T13:37:49.071939Z\"}]', 1, NULL, NULL, NULL, '2023-01-20 06:37:33', NULL);
